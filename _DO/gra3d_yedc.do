...
xtreg yedc year_2 year_3 year_4 year_5 year_6 year_7 year_8  dico 1.dic#dict female rural lnyhogpc b_y, re 

margins, nose  at(b_y=(1(1)11) year_2=(0(1)1) year_3=(0(1)1) year_4=(0(1)1) year_5=(0(1)1) year_6=(0(1)1) year_7=(0(1)1) year_8=(0(1)1)) ///
saving(_OUT\3dg.dta, replace)
...
replace yedc=yedc-1.423375 if dic==1

replace yedc=yedc+1.237067 if dict==1

replace yedc=yedc+0.9918482 if dict==2

replace yedc=yedc+0.7747195 if dict==3

replace yedc=yedc+0.5288539 if dict==4

replace yedc=yedc+0.4005962 if dict==5


save _OUT\3dg.dta, replace
...
# Read the data
data = pd.read_stata(r'F:\Trabajo\_PROYECTOS\_STATA\Proyecto_de_Investigacion\_OUT/3dg.dta')
...
for i in range(31):
	...
	ax.set_zticks(np.arange( 10, 14, step=1))
